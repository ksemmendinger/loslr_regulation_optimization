# this script simulated rule curve optimized policies in GLRRM
...
args = sys.argv
# args = ["", "/Users/austinraney/Library/CloudStorage/GoogleDrive-kylasr@umich.edu/My Drive/loslrRegulation", "adjANN_Bv7_offSepRule_netAnnualAverage_6month_0_91dv_7obj_historic_75000nfe"]
...
with open("output/data/" + expName + "/config.toml", "r") as f:
    config = toml.load(f)

# get run info - RC or ANN release function
...
inputData = v + "/" + v + "/" + leadtime + "_" + skill
...
for p in range(npol):
    ...
    # path to output
    output_path = Path("output/data/" + expName + "/simulation/historic")
